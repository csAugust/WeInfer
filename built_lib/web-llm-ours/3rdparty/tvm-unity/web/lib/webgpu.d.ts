...
export declare class WebGPUContext {
    ...
    private uniformBufferCreateCnt;
    private uniformBufferCreateRecord;
    private storageBufferCreateCnt;
    private storageBufferCreateRecord;
    private stageBufferCreateCnt;
    private resolveResultBuffers;
    private uniformBufferCache;
    private uniformCacheStatus;
    ...
    private logStatus;
    private logBufferStatus;
    private logPassCostStatus;
    private logUniformStatus;
}
