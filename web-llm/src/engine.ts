...
export class MLCEngine implements MLCEngineInterface {
  public gpuLabel: string = "Unknown";
  ...
  private async _generate(
    ...
    while (!this.stopped()) {
      ...
      console.log(`Decode time of ${counter}: ${curTime - lastStart} ms`)
      lastStart = curTime;
      // console.log("!!!Call decode from library")
  ...
  async chatCompletion(
    ...
    // console.log("!!!Call webllm.engine.chatCompletion from library")
    ...
    for (let i = 0; i < n; i++) {
      ...
      if (this.interruptSignal) {
        ...
        // console.log("!!!Call _generate from library")
  ...
  public getPipeline(): LLMChatPipeline {
